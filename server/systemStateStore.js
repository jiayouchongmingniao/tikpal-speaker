...
export function createSystemStateStore({ persistence = null, secretStore = null, otaManager = null } = {}) {
  ...
  function recordPerformanceSample(sample) {
    appendLog(performanceSamples, {
      ...
      rendererType: sample.rendererType ?? null,
      rendererFallbackCount: sample.rendererFallbackCount ?? null,
      glInitErrorCount: sample.glInitErrorCount ?? null,
      glContextLostCount: sample.glContextLostCount ?? null,
      ...
      if (type === "runtime_report_performance") {
        ...
        recordPerformanceSample({
          ...
          rendererFallbackCount:
            payload.rendererFallbackCount ?? liveState.system.performance?.rendererFallbackCount ?? 0,
          glInitErrorCount: payload.glInitErrorCount ?? liveState.system.performance?.glInitErrorCount ?? 0,
          glContextLostCount:
            payload.glContextLostCount ?? liveState.system.performance?.glContextLostCount ?? 0,
          rendererFallbackReason:
            payload.rendererFallbackReason ?? liveState.system.performance?.rendererFallbackReason ?? null,
          source,
        });
