...
export function getPerformanceDebugViewModel({ system = {}, runtimeSummary = null, draftAvgFps = null } = {}) {
  ...
  return {
    ...
    renderProfile,
    rendererType: runtimeSummary?.rendererType ?? performance.rendererType ?? "image",
    requestedRenderer: runtimeSummary?.requestedRenderer ?? performance.requestedRenderer ?? "image",
